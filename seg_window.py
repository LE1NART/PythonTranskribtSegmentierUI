...
class segWindow(tkinter.Toplevel):
    ...
    def __inside(self,menu,master):
        ...
        self.startButton = tkinter.Button(self, text="Segmentieren", command=lambda: self.__segmentieren(self.entryField.get(),self.outroField.get()))
